function [Ce_ANSYS,PressLoad_ANSYS_orig,PressLoad_ANSYS,IMF_ANSYS,FH_ANSYS_mod,FH_ANSYS_orig,QF_ANSYS] = map_CML_ANSYS_avg(PressLoad01,FH01,imf01,U,surf_ele_num,mu)
...
QF_ANSYS = getQ(-IMF_ANSYS,U,mu);

fid1 = fopen('QF_ANSYS.dat', 'w');
fprintf(fid1,'%15.3f\t%15.3f\t%15.3f\n',QF_ANSYS');
fclose(fid1);
